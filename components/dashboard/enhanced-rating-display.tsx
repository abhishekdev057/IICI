...
export function EnhancedRatingDisplay({ 
  ...
  return (
    <Card className={`${className} ${performanceInfo.bgColor} ${performanceInfo.borderColor} border-2`}>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-center gap-2">
              ...
              <h3 className="text-xl font-bold text-gray-900">Innovation Maturity Rating</h3>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 max-w-md mx-auto">
            <div className="text-center">
              ...
              <div className={`text-lg font-semibold ${performanceInfo.textColor}`}>
                {score.toFixed(0)}%
              </div>
            </div>
            <div className="text-center">
